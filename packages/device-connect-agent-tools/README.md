...
- **[device-connect-sdk](https://github.com/arm/device-connect-sdk)** — runs on edge hardware (Raspberry Pi, robots, cameras, sensors)
- **[device-connect-server](https://github.com/arm/device-connect-server)** — runs on servers. Adds registry, security, state, and CLIs
...
pip install git+https://github.com/arm/device-connect-agent-tools.git
```
...
pip install "device-connect-agent-tools[strands] @ git+https://github.com/arm/device-connect-agent-tools.git"
```
...
Agents need their own credentials generated by [device-connect-server](https://github.com/arm/device-connect-server#infrastructure):
...
Devices on the same LAN that are also running in P2P mode will be discovered automatically. See [device-connect-sdk](https://github.com/arm/device-connect-sdk#peer-to-peer-mode-no-infrastructure) for details.
...
We welcome contributions! Please open an [issue](https://github.com/arm/device-connect-agent-tools/issues) to report bugs or suggest features, or submit a [pull request](https://github.com/arm/device-connect-agent-tools/pulls) directly.
